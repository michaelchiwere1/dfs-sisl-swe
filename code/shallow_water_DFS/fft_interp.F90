...
!--------------------------------------------------------------
  ...
  private
  public :: fft__ini_interp, fft__togrid_interp, fft__towave_interp
...
subroutine fft__ini_interp(jcn_zonalfilter,m0,imax_in,jmax_in,mmax,coslat) !IN
!
...
!
end subroutine fft__ini_interp


!********************************************************************


subroutine fft__togrid_interp( a )   !INOUT
...
!
end subroutine fft__togrid_interp


!********************************************************************


subroutine fft__towave_interp( a )!INOUT
!
  real(8),intent(inout) :: a(IMAX,JMAX)
  real   (kind=8) :: aa(IMAX)
  integer :: i,j,ie
...
!
end subroutine fft__towave_interp


end module fft_interp
