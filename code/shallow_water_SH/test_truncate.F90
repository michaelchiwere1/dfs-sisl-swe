...
!
  ...
  call grads__outxy( "legendre_initial", 1, MMAX+1, JMAX, ylat, data_m ) !IN
  ...
  call grads__outxy( "legendre", 1, MMAX+1, JMAX, ylat, data_m ) !IN
!
end subroutine main
